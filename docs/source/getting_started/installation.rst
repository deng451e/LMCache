...
.. important::
   ...
   You're all set! You can now start using LMCache. For hands-on guides and more usage examples, see the Quickstart Examples section.
...
.. dropdown:: Full matrix as CSV (same file as the table above)
   :color: muted

   .. literalinclude:: installation_compatibility.csv
      :language: text
